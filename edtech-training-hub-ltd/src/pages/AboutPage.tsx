    ...
    <div className="space-y-20 sm:space-y-28 pb-20">
            ...
            {fourPillars.map((p, idx) => {
              ...
              return (
                <Reveal
                  key={idx}
                  delay={(idx % 4) * 0.06}
                  className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all flex flex-col space-y-3"
                >
                  <div
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Vision */}
          <Reveal className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
          ...
          {/* Mission */}
          <Reveal delay={0.1} className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
      ...
      {/* 5. OUR APPROACH & GOAL */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 lg:p-16 space-y-8">
